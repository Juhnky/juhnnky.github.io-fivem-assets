...
// Get the current time with beating
...
// Automatically increase the number
window.onload = function() {
    // After the number reaches 100, it is restored to 1
    var max = 11000000,
    ...
    // Update the number every 0.1 seconds and save the data
    setInterval(function() {
